              ...
              {Object.keys(conversations).map((convKey) => (
                ...
                >
                  {conversations[convKey][0]?.senderId?._id === user._id
                    ? `${conversations[convKey][0]?.receiverId?.brandName} ${conversations[convKey][0]?.receiverId?.brandName}` ||
                      "Unknown"
                    : `${conversations[convKey][0]?.senderId?.firstName} ${conversations[convKey][0]?.senderId?.lastName}` ||
                      "Unknown"}
                </li>
              ))}
            </ul>
          ...
          {selectedConversation ? (
            <>
              <h2>
                ...
                user._id
                  ? `${conversations[selectedConversation][0]?.receiverId?.brandName} ${conversations[selectedConversation][0]?.receiverId?.brandName}` ||
                    "Unknown"
                  : `${conversations[selectedConversation][0]?.senderId?.firstName} ${conversations[selectedConversation][0]?.senderId?.lastName}` ||
                    "Unknown"}
              </h2>
